...
import bg_img_e from "./../../../assets/images/agsbackgrounds/backgroundCurve.png";
    ...
    return (
            ...
            <div className="ac-main school-main">
                <div className="ac-bg">
                    ...
                    <h3 className="InfoTitle-Ethos">OPEN POSITIONS</h3>
                        ...
                        <div>
                            <Card className={"cardStyle"}>
                                <Card.Body >
                                    ...
                                    <br />
                                    <Col xs={12} sm={12} md={12} lg={12}>
                                    <button class="schoolbtn btn-lg">School Clinic</button>
                                    </Col>
                                    </Row>
                                </Card.Body>
                            </Card>
