...
import qliq1 from "../../../assets/images/deliveryPartnerImgs/lifeatqliq.png"
import ArrowForwardIosIcon from '@material-ui/icons/ArrowForwardIos';
import ArrowBackIosIcon from '@material-ui/icons/ArrowBackIos';

export default function LifeAtQliq() {

    const slidesData = [
        {
            title: "Monthly fun filled events ",
    ...
    return (
        <div className={"life-at-qliq"}>
            <h3 className={"InfoTitle"}>Why join QLIQ</h3>
            <Carousel
                autoPlay={true}
                dynamicHeight={false}
                showStatus={false}
