            ...
            <Container>
                ...
                <div className={"SchoolMiddlespacing"} id={"ACADEMIC"}>
                    <Row>
                        ...
                        <p className={"subTitle"}>
                        Being inquiry based, the PYP program allows our learners ample opportunities to personalize their learning experiences, with the support
                        and guidance of our highly skilled teaching and support staff.
                        </p>
                        <p className={"subTitle"}>
