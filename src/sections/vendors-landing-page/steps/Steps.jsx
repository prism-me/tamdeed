...
export default function Steps() {
    ...
    const slidesData = [
        {
            ...
            Subtitle1: "We have a simple onboarding and registration process which our onboarding team will assist you with.",
            thumbnail: qliq1,
        },
        {
            title: step1,
    ...
    return (
        <div className={"six-steps"}>
            <h3 className={"Title"}>How to partner with us</h3>
            <Carousel
                autoPlay={true}
                dynamicHeight={false}
                showStatus={false}
